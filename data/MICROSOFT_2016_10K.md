...
+--------------+----------+----------------------------------------------------------------------------------------------------------------------------------------------------------+----------+
|              | Item 2.  | [Properties]{.underline}                                                                                                                                 | 26       |
+--------------+----------+----------------------------------------------------------------------------------------------------------------------------------------------------------+----------+
...
+--------------+----------+----------------------------------------------------------------------------------------------------------------------------------------------------------+----------+
|              | Item 12. | [Securi]{.underline}ty [Ownership of Certain Beneficial Owners and Management and Related Stockholder Matters]{.underline}                               | 98       |
+--------------+----------+----------------------------------------------------------------------------------------------------------------------------------------------------------+----------+
...
[IMPAIRMENT, INTEGRATION, AND RESTRUCTURING EXPENSES]{.underline}
...
[OTHER INCOME]{.underline} ([EXPENSE]{.underline}) , [NET]{.underline}
...
Cash flows from operations increased $3.7 billion to $33.3 billion during the fiscal year, mainly due to lower operating expenditures and a reduction in materials and production costs, offset in part by a decrease in cash received from customers. Cash used in financing decreased $1.3 billion to
...
## Unearned Revenue {#unearned-revenue-1 .unnumbered}
...
Should we require more capital in the U.S. than is generated by our operations domestically, for example to fund significant discretionary activities, such as business acquisitions and share repurchases, we could elect to repatriate future earnings from foreign jurisdictions or raise capital in the

U.S. through debt or equity issuances. These alternatives could result in higher effective tax rates, increased interest expense, or dilution of our earnings. We have borrowed funds domestically and continue to believe we have the ability to do so at reasonable interest rates.
...
## Foreign Currency {#foreign-currency .unnumbered}
...
## Commodity {#commodity .unnumbered}
...
# COMPREHENSIVE INCOME STATEMENTS {#comprehensive-income-statements .unnumbered}
...
# BALANCE SHEETS {#balance-sheets .unnumbered}
...
## Product Revenue and Service and Other Revenue {#product-revenue-and-service-and-other-revenue-1 .unnumbered}
...
## Allowance for Doubtful Accounts {#allowance-for-doubtful-accounts .unnumbered}
...
## Recent Accounting Guidance {#recent-accounting-guidance .unnumbered}

*Recently adopted accounting guidance*

[Improvements to Employee Share-Based Payment Accountin]{.underline}g
...
[Balance Sheet Classification of Deferred Taxes]{.underline}
...
[Financial Instruments -- Credit Losses]{.underline}
...
[Financial Instruments -- Recognition, Measurement, Presentation, and Disclosure]{.underline}
...
[Revenue from Contracts with Customers]{.underline}
...
|                                                         | [PART II]{.underline} |              |   |          |   |          |
+=========================================================+=======================+==============+===+==========+===+==========+
| The components of basic and diluted EPS are as follows: | Item 8                |              |   |          |   |          |
+---------------------------------------------------------+-----------------------+--------------+---+----------+---+----------+
...
[NOTE 3 --- OTHER INCOME]{.underline} ([EXPENSE]{.underline}) , [NET]{.underline}
...
+---------------------------------------+----------------+----------------+----------------+--------------+-------------------------------+----------------------------+----------------------------------+
| **(In millions)**                     | **Cost Basis** | **Unrealized** | **Unrealized** | **Recorded** | **Cash and Cash Equivalents** | **Short-term Investments** | **Equity and Other Investments** |
|                                       |                |                |                |              |                               |                            |                                  |
|                                       |                | **Gains**      | **Losses**     | **Basis**    |                               |                            |                                  |
+=======================================+================+================+================+==============+===============================+============================+==================================+
| **June 30, 2016**                     |                |                |                |              |                               |                            |                                  |
...
## Unrealized Losses on Investments {#unrealized-losses-on-investments .unnumbered}
...
## Foreign Currency {#foreign-currency-1 .unnumbered}
...
## Commodity {#commodity-1 .unnumbered}
...
## Fair Values of Derivative Instruments {#fair-values-of-derivative-instruments .unnumbered}
...
|                                      |                 |     | **Other**   |     | **Equity and**  | **Other**         |     |                 |     | **Other**   |     | **Equity and**  | **Other**         |
|                                      | **Short-term**  |     | **Current** |     | **Other**       | **Current**       |     | **Short-term**  |     | **Current** |     | **Other**       | **Current**       |
| **(In millions)**                    | **Investments** |     | **Assets**  |     | **Investments** | **Liabilities**   |     | **Investments** |     | **Assets**  |     | **Investments** | **Liabilities**   |
...
## Fair Value Hedge Gains (Losses) {#fair-value-hedge-gains-losses .unnumbered}
...
| **(In millions)**                                                                                        |             |          |   |          |
+==========================================================================================================+=============+==========+===+==========+
| **Year Ended June 30, Foreign Exchange Contracts**                                                       | **2016**    | **2015** |   | **2014** |
+----------------------------------------------------------------------------------------------------------+-------------+----------+---+----------+
...
| **(In millions)**                                                                                        |             |          |   |          |
+----------------------------------------------------------------------------------------------------------+-------------+----------+---+----------+
| **Year Ended June 30, Effective Portion**                                                                | **2016**    | **2015** |   | **2014** |
+----------------------------------------------------------------------------------------------------------+-------------+----------+---+----------+
...
## Non-Designated Derivative Gains (Losses) {#non-designated-derivative-gains-losses .unnumbered}
...
[NOTE 6 --- FAIR VALUE MEASUREMENTS]{.underline}

## Assets and Liabilities Measured at Fair Value on a Recurring Basis {#assets-and-liabilities-measured-at-fair-value-on-a-recurring-basis .unnumbered}
...
## Financial Assets and Liabilities Measured at Fair Value on a Nonrecurring Basis {#financial-assets-and-liabilities-measured-at-fair-value-on-a-nonrecurring-basis .unnumbered}
...
[NOTE 8 --- PROPERTY AND E]{.underline}Q[UIPMENT]{.underline}
...
## Mojang Synergies AB {#mojang-synergies-ab .unnumbered}

[PART II]{.underline}

Item 8

[NOTE 9 --- BUSINESS COMBINATIONS]{.underline}
...
## Nokia's Devices and Services Business {#nokias-devices-and-services-business .unnumbered}
...
[NOTE 10 --- GOODWILL]{.underline}

+---------------------+--------------+------------------+-----------+--------------+------------------+-----------+--------------+---+
|                     | **June 30,** |                  |           | **June 30,** |                  |           | **June 30,** |   |
+=====================+==============+==================+===========+==============+==================+===========+==============+===+
| **(In millions)**   | **2014**     | **Acquisitions** | **Other** | **2015**     | **Acquisitions** | **Other** | **2016**     |   |
+---------------------+--------------+------------------+-----------+--------------+------------------+-----------+--------------+---+
...
[NOTE 11 --- INTANGIBLE ASSETS]{.underline}
...
<th colspan="2"><p><strong>Gross Carrying Amount</strong></p></th>
<th colspan="3"><p><strong>Accumulated Amortization</strong></p></th>
<th colspan="3"><p><strong>Net Carrying</strong></p>
...
<tr class="even">
<td>Technology-based (a)</td>
<td colspan="2"><strong>$ 5,970</strong></td>
<td colspan="3"><p><strong>$ (3,648)</strong></p></td>
<td colspan="3"><p><strong>$ 2,322</strong></p></td>
<td colspan="2"><p>$ 5,926</p></td>
<td colspan="3"><p>$ (3,149)</p></td>
<td colspan="4"><p>$ 2,777</p></td>
</tr>
<tr class="odd">
<td>Marketing-related</td>
<td colspan="2"><strong>1,869</strong></td>
<td colspan="3"><strong>(616)</strong></td>
<td colspan="3"><p><strong>1,253</strong></p></td>
<td colspan="2"><p>1,942</p></td>
<td colspan="3">(508)</td>
<td colspan="4"><p>1,434</p></td>
</tr>
<tr class="even">
<td>Contract-based</td>
<td colspan="2"><strong>796</strong></td>
<td colspan="3"><strong>(718)</strong></td>
<td colspan="3"><strong>78</strong></td>
<td colspan="2"><p>1,192</p></td>
<td colspan="3">(710)</td>
<td colspan="4">482</td>
</tr>
<tr class="odd">
<td>Customer-related</td>
<td colspan="2"><strong>465</strong></td>
<td colspan="3"><strong>(385)</strong></td>
<td colspan="3"><strong>80</strong></td>
<td colspan="2">492</td>
<td colspan="3">(350)</td>
<td colspan="4">142</td>
</tr>
...
<td><p>Total</p></td>
<td><strong>$</strong></td>
<td><p><strong>9,100</strong></p></td>
<td></td>
<td><p><strong>$</strong></p></td>
<td><p><strong>(5,367)</strong></p></td>
<td></td>
<td><p><strong>$</strong></p></td>
<td><p><strong>3,733</strong></p></td>
<td></td>
<td><p>$ 9,552</p></td>
<td></td>
<td><p>$</p></td>
...
## Long-term Debt {#long-term-debt .unnumbered}
...
+----------------------------+-------------------------+---+-------------------------+---------------------+------------------------+
|                            | **Face Value June 30,** |   | **Face Value June 30,** | **Stated Interest** | **Effective Interest** |
+============================+=========================+===+=========================+=====================+========================+
| **Due Date**               | **2016**                |   | **2015**                | **Rate**            | **Rate**               |
+----------------------------+-------------------------+---+-------------------------+---------------------+------------------------+
| **Notes**                  |                         |   | **(In millions)**       |                     |                        |
+----------------------------+-------------------------+---+-------------------------+---------------------+------------------------+
...
[NOTE 13 --- INCOME TAXES]{.underline}
...
| **(In millions)**                                                                 |              |   |          |   |   |          |
+-----------------------------------------------------------------------------------+--------------+---+----------+---+---+----------+
| **Year Ended June 30, Current Taxes**                                             | **2016**     |   | **2015** |   |   | **2014** |
+-----------------------------------------------------------------------------------+--------------+---+----------+---+---+----------+
...
$124.0 billion resulting from earnings for certain non-U.S. subsidiaries which are permanently reinvested outside the U.S. The unrecognized deferred tax liability associated with these temporary differences was approximately $39.3 billion as of June 30, 2016.
...
[NOTE 14 --- RESTRUCTURING CHARGES]{.underline}
...
|                                             | Item 8                                     |              |   |          |
|                                             |                                            |              |   |          |
|                                             | [NOTE 15 --- UNEARNED REVENUE]{.underline} |              |   |          |
+---------------------------------------------+--------------------------------------------+--------------+---+----------+
...
[NOTE 16 --- COMMITMENTS]{.underline}

## Construction and Operating Lease Commitments {#construction-and-operating-lease-commitments .unnumbered}
...
## Other Commitments {#other-commitments .unnumbered}
...
## Patent and Intellectual Property Claims {#patent-and-intellectual-property-claims .unnumbered}
...
[NOTE 17 --- CONTINGENCIES]{.underline}
...
## Antitrust, Unfair Competition, and Overcharge Class Actions {#antitrust-unfair-competition-and-overcharge-class-actions .unnumbered}
...
## Other Antitrust Litigation and Claims {#other-antitrust-litigation-and-claims .unnumbered}
...
## Product-Related Litigation {#product-related-litigation .unnumbered}
...
[NOTE 18 --- STOCKHOLDERS' E]{.underline}Q[UITY]{.underline}
...
[NOTE 19 --- ACCUMULATED OTHER COMPREHENSIVE INCOME]{.underline}
...
| **(In millions)**                                                                                  |               |   |           |   |          |
+----------------------------------------------------------------------------------------------------+---------------+---+-----------+---+----------+
| **Year Ended June 30, Derivatives**                                                                | **2016**      |   | **2015**  |   | **2014** |
+----------------------------------------------------------------------------------------------------+---------------+---+-----------+---+----------+
...
[NOTE 20 --- EMPLOYEE STOCK AND SAVINGS PLANS]{.underline}
...
+----------------------------------------------------------------------------------------+---------------------+---------------------------------+--------------------------------------------+
| *Activity for all stock plans*                                                         | assumptions:        |                                 |                                            |
|                                                                                        |                     |                                 |                                            |
| The fair value of stock awards were estimated on the date of grant using the following |                     |                                 |                                            |
+========================================================================================+=====================+=================================+============================================+
| **Year Ended June 30,**                                                                | **2016**            | **2015**                        | **2014**                                   |
+----------------------------------------------------------------------------------------+---------------------+---------------------------------+--------------------------------------------+
...
As of June 30, 2016, there was approximately $4.8 billion of total unrecognized compensation costs related to stock awards. These costs are expected to be recognized over a weighted average period of 3 years. The weighted average grant-date fair value of stock award granted was

$41.51, $42.36, and $31.50 for fiscal years 2016, 2015, and 2014, respectively. The fair value of stock awards vested was $3.9 billion, $4.2 billion, and $3.2 billion, for fiscal years 2016, 2015, and 2014, respectively.
...
## Savings Plan {#savings-plan .unnumbered}
...
[NOTE 21 --- SEGMENT INFORMATION AND GEOGRAPHIC DATA]{.underline}
...
| **(In millions)**                   |                     |   |          |   |          |
+=====================================+=====================+===+==========+===+==========+
| **Year Ended June 30, Revenue**     | **2016**            |   | **2015** |   | **2014** |
+-------------------------------------+---------------------+---+----------+---+----------+
...
| **(In millions)**                               |                       |              |   |          |   |          |
+-------------------------------------------------+-----------------------+--------------+---+----------+---+----------+
| **Year Ended June 30, Operating income (loss)** |                       | **2016**     |   | **2015** |   | **2014** |
+-------------------------------------------------+-----------------------+--------------+---+----------+---+----------+
...
$9.5 billion, $5.8 billion, and $2.8 billion in fiscal years 2016, 2015, and 2014, respectively. These amounts are included in their respective product categories in the table above.
...
[NOTE 22 --- QUARTERLY INFORMATION]{.underline} ([UNAUDITED]{.underline})

+---------------------------------------------+------------------+-----------------+----------+--------------+----------+---------------+-------------+----------------+
| **(In millions, except per share amounts)** |                  |                 |          |              |          |               |             |                |
+=============================================+==================+=================+==========+==============+==========+===============+=============+================+
| **Quarter Ended Fiscal Year 2016**          | **September 30** | **December 31** |          | **March 31** |          | **June 30**   |             | **Total**      |
+---------------------------------------------+------------------+-----------------+----------+--------------+----------+---------------+-------------+----------------+
...
[/s/ Deloitte & Touche LLP]{.smallcaps}
...
[[Income Statements]{.underline} 52](#income-statements)

[[Comprehensive Income Statements]{.underline} 53](#comprehensive-income-statements)

[[Balance Sheets]{.underline} 54](#balance-sheets)

[[Cash Flows Statements]{.underline} 55](#cash-flows-statements)

[Stockholders' Equi]{.underline}ty [Statements]{.underline} 56

[[Notes to Financial Statements]{.underline} 57](#notes-to-financial-statements)

[[Report of Independent Registered Public Accounting Firm]{.underline} 95](#report-of-independent-registered-public-accounting-firm)
...
+--------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+-----------+-------------------+-------------+-----------------+
| **Exhibit Number** | **Ehibit Description**                                                                                                                                                                                                                                        | **Filed Herewith** | **Form**  | **Period Ending** | **Exhibit** | **Filing Date** |
+====================+===============================================================================================================================================================================================================================================================+====================+===========+===================+=============+=================+
...
+--------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+-----------+-------------------+-------------+-----------------+
| 3.1                | Amended and Restated Articles of Incorporation of Microsoft Corporation                                                                                                                                                                                       |                    | 8-K       |                   | 3.1         | 3/17/16         |
+--------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+-----------+-------------------+-------------+-----------------+
| 3.2                | Bylaws of Microsoft Corporation                                                                                                                                                                                                                               |                    | 8-K       |                   | 3.2         | 7/5/16          |
+--------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+-----------+-------------------+-------------+-----------------+
...
+--------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------+-----------+-------------------+-------------+-----------------+
| 4.5                | Form of Second Supplemental Indenture for 0.875% Notes due 2013, 1.625% Notes due 2015, 3.00% Notes due 2020, and                                                                                                                                             |                    | 8-K       |                   | 4.5         | 9/27/10         |
|                    |                                                                                                                                                                                                                                                               |                    |           |                   |             |                 |
|                    | 4.50% Notes due 2040, dated as of September 27, 2010, between Microsoft Corporation and The Bank of New York Mellon Trust Company, N.A., as Trustee, to the Indenture, dated as of May 18, 2009, between Microsoft Corporation and The                        |                    |           |                   |             |                 |
|                    |                                                                                                                                                                                                                                                               |                    |           |                   |             |                 |
...
**[Incorporated by Reference]{.underline}**
...
+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------+----------+------------+-------------+-----------------+
| 4.9        | Sixth Supplemental Indenture for 1.000% Notes due 2018, 2.375%                                                                                                                                                                                                                                                                                                                    |              | 8-K      |            | 4.2         | 5/1/13          |
|            |                                                                                                                                                                                                                                                                                                                                                                                   |              |          |            |             |                 |
|            | Notes due 2023, and 3.750% Notes due 2043, dated as of May 2, 2013, between Microsoft Corporation and The Bank of New York Mellon Trust Company, N.A., as Trustee, to the Indenture, dated as of May 18, 2009, between Microsoft Corporation and The Bank of New York Mellon Trust Company, N.A., as Trustee                                                                      |              |          |            |             |                 |
+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------+----------+------------+-------------+-----------------+
...
| **Number** | **Exhibit Description**                                                                                                                                                                                                                                                                                           | **Herewith** | **Form** | **Ending** | **Exhibit** | **Filing Date** |
+============+===================================================================================================================================================================================================================================================================================================================+==============+==========+============+=============+=================+
| 4.12       | Ninth Supplemental Indenture for 1.850% Notes due 2020, 2.375% Notes due 2022, 2.700% Notes due 2025, 3.500% Notes due 2035, 3.750% Notes                                                                                                                                                                         |              | 8-K      |            | 4.1         | 2/12/15         |
|            |                                                                                                                                                                                                                                                                                                                   |              |          |            |             |                 |
|            | due 2045, and 4.000% Notes due 2055, dated as of February 12, 2015, between Microsoft Corporation and U.S. Bank National Association, as Trustee, to the Indenture, dated as of May 18, 2009, between Microsoft Corporation and The Bank of New York Mellon Trust Company, N.A., as Trustee                       |              |          |            |             |                 |
+------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------+----------+------------+-------------+-----------------+
| 4.13       | Tenth Supplemental Indenture for 1.300% Notes due 2018, 2.000% Notes due 2020, 2.650% Notes due 2022, 3.125% Notes due 2025, 4.200% Notes                                                                                                                                                                         |              | 8-K      |            | 4.1         | 11/3/15         |
|            |                                                                                                                                                                                                                                                                                                                   |              |          |            |             |                 |
|            | due 2035, 4.450% Notes due 2045, and 4.750% Notes due 2055, dated as of November 3, 2015, between Microsoft Corporation and U.S. Bank National Association, as Trustee, to the Indenture, dated as of May 18, 2009, between Microsoft Corporation and The Bank of New York Mellon Trust Company, N.A., as Trustee |              |          |            |             |                 |
+------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------+----------+------------+-------------+-----------------+
...
[/s/ John W. Thompson]{.smallcaps}

John W. Thompson

[/s/ Satya Nadella]{.smallcaps}
...
[/s/ G. Mason Morfit]{.smallcaps}

G. Mason Morfit

[/s/ Charles H. Noski]{.smallcaps}

Charles H. Noski

[/s/ Helmut Panke]{.smallcaps}

Helmut Panke

[/s/ Sandra E. Peterson]{.smallcaps}

Sandra E. Peterson

[/s/ Charles W. Scharf]{.smallcaps}

Charles W. Scharf

[/s/ John W. Stanton]{.smallcaps}

John W. Stanton

[/s/ Padmasree Warrior]{.smallcaps}
...
2.  [Definitions]{.underline}. As used herein, the following definitions shall apply:

    a.  "[Award]{.underline}" shall mean any award or benefits granted under the Plan, including Options, Stock Awards, and SARs.

    b.  "[Award Agreement]{.underline}" shall mean a written or electronic agreement between the Company and the Awardee setting forth the terms of the Award.

    c.  "[Awardee]{.underline}" shall mean the holder of an outstanding Award.

    d.  "[Board]{.underline}" shall mean (i) the Board of Directors of the Company or (ii) both the Board and the Committee, if a Committee has been appointed in accordance with Section 4(a) of the Plan.

    e.  "[Code]{.underline}" shall mean the Internal Revenue Code of 1986, as amended.

    f.  "[Committee]{.underline}" shall mean the Compensation Committee appointed by the Board of Directors in accordance with Section 4(a) of the Plan, if one is appointed; provided, however, if the Board of Directors appoints more than one Committee pursuant to Section 4(a), then "Committee" shall refer to the appropriate Committee, as indicated by the context of the reference.

    g.  "[Common Shares]{.underline}" shall mean the common shares of Microsoft Corporation.

    h.  "[Company]{.underline}" shall mean Microsoft Corporation, a Washington corporation and any successor thereto.

    i.  "[Consultant]{.underline}" shall mean any person, except an Employee, engaged by the Company or any Parent or Subsidiary of the Company, to render personal services to such entity, including as an advisor.

    j.  "[Continuous Status as a Participant]{.underline}" shall mean (1) for Employees, the absence of any interruption or termination of service as an Employee, and (2) for Consultants, the absence of any interruption, expiration, or termination of such person's consulting or advisory relationship with the Company or the occurrence of any termination event as set forth in such person's Award Agreement. Continuous Status as a Participant shall not be considered interrupted (i) for an Employee in the case of sick leave, maternity leave, infant care leave, medical emergency leave, military leave, or any other leave of absence for which Continuous Status is not considered interrupted in accordance with the Company's policies on such matters, and (ii) for a Consultant, in the case of any temporary interruption in such person's availability to provide services to the Company which has been authorized in writing by a Vice President of the Company prior to its commencement.

    k.  "[Conversion Options]{.underline}" shall mean the Options described in Section 6(c) of the Plan.

    l.  "[Employee]{.underline}" shall mean any person, including an officer, who is a common law employee of, receives remuneration for personal services to, is reflected on the official human resources database as an employee of, and is on the payroll of the Company or any Parent or Subsidiary of the Company. A person
...
m.  "[Effective Date]{.underline}" shall mean January 1, 2001.

n.  "[Exchange Act]{.underline}" shall mean the Securities Exchange Act of 1934, as amended.

o.  "[Incentive Stock Option]{.underline}" shall mean any Option intended to qualify as an incentive stock option within the meaning of Section 422 of the Code.

p.  ["Maximum Annual Participant Award]{.underline}" shall have the meaning set forth in Section 5(b).

q.  "[Nonqualified Stock Option]{.underline}" shall mean an Option not intended to qualify as an Incentive Stock Option.

r.  "[Option]{.underline}" shall mean a stock option granted pursuant to Section 6 of the Plan.

s.  "[Parent]{.underline}" shall mean a "parent corporation," whether now or hereafter existing, as defined in Section 424(e) of the Code.

t.  "[Participant]{.underline}" shall mean an Employee or Consultant.

u.  "[Plan]{.underline}" shall mean this 2001 Stock Plan, including any amendments thereto.

v.  "[Share]{.underline}" shall mean one Common Share, as adjusted in accordance with Section 14 of the Plan.

w.  "[SAR]{.underline}" shall mean a stock appreciation right awarded pursuant to Section 8 of the Plan.

x.  "[Stock Award]{.underline}" shall mean a grant of Shares or of a right to receive Shares or their cash equivalent (or both) pursuant to Section 7 of the Plan.

y.  "[Subsidiary]{.underline}" shall mean (i) in the case of an Incentive Stock Option a "subsidiary corporation," whether now or hereafter existing, as defined in Section 424(f) of the Code, and (ii) in the case of a Nonqualified Stock Option, a Stock Award or an SAR, with the approval of the Board, Committee or other person authorized to administer the Plan in accordance with Section 4 of the Plan, a limited liability company, partnership or other entity in which the Company controls 50 percent or more of the voting power or equity interests.

```{=html}
<!-- -->
```
3.  [Shares Sub]{.underline}j[ect to the Plan]{.underline}. Subject to the provisions of Sections 14 and 16 of the Plan, the maximum aggregate number of Shares (increased, proportionately, in the event of any stock split, stock dividend or similar event with respect to the Shares) which may be awarded and delivered under the Plan shall not exceed the sum of (a) any Shares available for future awards, as of the Effective Date, under the Microsoft Corporation 1991 Stock Option Plan, as amended ("1991 Stock Plan") and (b) any Shares that are represented by awards under the 1991 Stock Plan which, after the Effective Date, are forfeited, expire, are cancelled without delivery of Shares, or otherwise result in the return of Shares to the Company, minus (c) 100,000,000 Shares (unadjusted for any stock split or stock dividend with respect to the Shares). The Shares may be authorized, but unissued, or reacquired Common Shares.
...
4.  [Administration of the Plan]{.underline}.

    a.  [Procedure]{.underline}. The Plan shall be administered by the Board of Directors of the Company.
...
c.  [Effect of Board's Decision]{.underline}. All decisions, determinations, and interpretations of the Board shall be final and binding on all Participants and Awardees.

```{=html}
<!-- -->
```
5.  [El]{.underline}ig[ibili]{.underline}ty.
...
8.  [SARs]{.underline}.
    ...
    b.  [Tandem SARs]{.underline}.
        ...
        iii. If the surrender of an Option is not approved by the Committee, then the Awardee shall retain whatever rights he or she had under the surrendered Option (or surrendered portion thereof) on the Option surrender date and may exercise such rights at any time prior to the later of

             A.  five (5) business days after the receipt of the rejection notice or (B) the last day on which the Option is otherwise exercisable in accordance with the terms of the instrument evidencing such Option, but in no event may such rights be exercised more than ten (10) years after the date of the Option grant.

    c.  [Stand-Alone SARs]{.underline}.

        i.  An Awardee may be granted a Stand-Alone SAR not tied to any underlying Option under Section 6 of the Plan. The Stand-Alone SAR shall cover a specified number of Common Shares and shall be exercisable upon such terms and conditions as the Committee shall establish. Upon exercise of the Stand-Alone SAR, the holder shall be entitled to receive a distribution from the Company in an amount equal to the excess of
...
9.  [Term of Plan]{.underline}. The Plan shall become effective as of the Effective Date. It shall continue in effect until terminated under Section 17 of the Plan.

10. [Term of Award; Limitations on Vesting and Repricing]{.underline}.
...
11. [Exercise Price and Consideration]{.underline}.
...
<!-- -->
```
12. [Exercise of Award]{.underline}.

    a.  [Procedure for Exercise; R]{.underline}ig[hts as a Shareholder]{.underline}. Any Award granted hereunder shall be exercisable at such times and under such conditions as determined by the Board at the time of grant, and as shall be permissible under the terms of the Plan.
...
Chief Executive Officer July 28, 2016
